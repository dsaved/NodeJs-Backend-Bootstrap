...
export class User extends BaseModel {
  ...
  // For TypeORM: Use enum with proper enum definition  
  // For Sequelize: Use 'varchar' with enum values as comment: /* VALUES: 0, 1 for male, female */
  // For Prisma: Define enum in schema.prisma file
  // For None: Use number with validation in service layer
  @Column({
    name: 'gender',
    type: 'enum',
